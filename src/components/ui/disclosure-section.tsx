...
export default function DisclosureSection({ title, icon: Icon, children, defaultOpen }: DisclosureSectionProps) {
  return (
    <Disclosure as="div" className="border-border/50 -mx-2 border-b sm:-mx-3 lg:-mx-4" defaultOpen={defaultOpen}>
      <DisclosureButton className="group data-open:border-border/50 focus-outline from-emphasized-background flex w-full items-center justify-between bg-gradient-to-r px-4 py-8 hover:to-rose-500/50 data-open:border-b">
