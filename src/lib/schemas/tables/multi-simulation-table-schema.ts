...
export const multiSimulationTableRowSchema = z.object({
  ...
  lifetimeFederalIncomeTax: z.number().nullable(),
  lifetimeFicaTax: z.number().nullable(),
  lifetimeCapitalGainsTax: z.number().nullable(),
...
const MULTI_SIMULATION_COLUMNS = {
  ...
  lifetimeFederalIncomeTax: { title: 'Lifetime Fed. Income Tax', format: 'currency' },
  lifetimeFicaTax: { title: 'Lifetime FICA Tax', format: 'currency' },
  lifetimeCapitalGainsTax: { title: 'Lifetime Capital Gains Tax', format: 'currency' },
