...
export const singleSimulationCashFlowTableRowSchema = z.object({
  ...
  federalIncomeTax: z.number().nullable(),
  ficaTax: z.number().nullable(),
  capitalGainsTax: z.number().nullable(),
...
const SINGLE_SIMULATION_CASH_FLOW_COLUMNS = {
  ...
  federalIncomeTax: { title: 'Fed. Income Tax', format: 'currency' },
  ficaTax: { title: 'FICA Tax', format: 'currency' },
  capitalGainsTax: { title: 'Capital Gains Tax', format: 'currency' },
...
export const singleSimulationTaxesTableRowSchema = z.object({
  ...
  annualFederalIncomeTax: z.number().nullable(),
  cumulativeFederalIncomeTax: z.number().nullable(),
  effectiveFederalIncomeTaxRate: z.number().nullable(),
  topMarginalFederalIncomeTaxRate: z.number().nullable(),
  ...
  annualCapitalGainsTax: z.number().nullable(),
  cumulativeCapitalGainsTax: z.number().nullable(),
  effectiveCapitalGainsTaxRate: z.number().nullable(),
  topMarginalCapitalGainsTaxRate: z.number().nullable(),
...
const SINGLE_SIMULATION_TAXES_COLUMNS = {
  ...
  annualFederalIncomeTax: { title: 'Annual Fed. Income Tax', format: 'currency' },
  cumulativeFederalIncomeTax: { title: 'Cumulative Fed. Income Tax', format: 'currency' },
  effectiveFederalIncomeTaxRate: { title: 'Effective Fed. Income Tax Rate', format: 'percentage' },
  topMarginalFederalIncomeTaxRate: { title: 'Top Marginal Fed. Income Tax Rate', format: 'percentage' },
  socialSecurityIncome: { title: 'Social Security Income', format: 'currency' },
  ...
  annualCapitalGainsTax: { title: 'Annual Capital Gains Tax', format: 'currency' },
  cumulativeCapitalGainsTax: { title: 'Cumulative Capital Gains Tax', format: 'currency' },
  effectiveCapitalGainsTaxRate: { title: 'Effective Capital Gains Tax Rate', format: 'percentage' },
  topMarginalCapitalGainsTaxRate: { title: 'Top Marginal Capital Gains Tax Rate', format: 'percentage' },
