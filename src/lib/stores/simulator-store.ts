...
interface SimulatorState {
  ...
  insights: {
    selectedPlan: { id: Id<'plans'>; name: string; keyMetrics: KeyMetrics | null } | undefined;
  };
  ...
  actions: {
    ...
    /* Insights */
    updateInsightsSelectedPlan: (plan: { id: Id<'plans'>; name: string; keyMetrics: KeyMetrics | null } | undefined) => void;
  };
}
