...
export default function SyncWithNetWorthTrackerSelect({
  ...
  return (
    <Field className={className}>
      <Label htmlFor={fieldId} className="flex w-full items-center justify-between">
        <span className="flex items-center gap-1.5">
          <LinkIcon className="text-muted-foreground hidden size-3.5 shrink-0 sm:inline-block" />
          <span className="whitespace-nowrap sm:hidden">Synced With</span>
          <span className="hidden whitespace-nowrap sm:inline">Sync w/ NW Tracker</span>
        </span>
        <Tooltip>
          ...
          <TooltipContent>
            <p>Auto-updates values when the synced NW Tracker entry changes.</p>
          </TooltipContent>
        </Tooltip>
      </Label>
