              ...
              return (
                <button
                  ...
                  className={classNames(
                    ...
                    "group focus-visible:outline-foreground inline-flex items-center border-b-2 px-1 py-4 text-sm font-medium focus-visible:outline-2 focus-visible:outline-offset-2"
                  )}
                >
                  <tab.icon
                    aria-hidden="true"
