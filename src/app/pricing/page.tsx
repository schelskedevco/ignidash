...
const tiers = [
  {
    ...
    priceMonthly: "$9",
    description:
      "Everything you need to plan your path to financial independence.",
    features: [
  ...
  },
  {
    ...
    priceMonthly: "$17",
    description:
      "Get AI-powered insights and guidance for confident decisions.",
    features: [
      "Everything in Pro",
    ...
    <>
      ...
      <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">
          Get beyond the numbers to explore what&apos;s actually possible. From
          Coast FIRE to career changes, discover your path to financial
